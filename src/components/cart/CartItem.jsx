...
{/* az order gombot (function + design)
illetve 500px ig nez ki jol alatta nem*/ }
  ...
  return (
    <div className='cart-item'>
      <div className='img-and-name'>
        <img className='cart-image' src={image} width='65px' height='65px'/>
        <p className='item-name'>{name} {cartAmount}x</p>
      </div> 
